...
//
//
//abstract class Node(var parent: MidNode?){
//    abstract fun rightLeaf(): Leaf
//    abstract fun leftLeaf(): Leaf
//    abstract fun reduce(level:Int = 0, explode:Boolean =true):Boolean
...
//}
//
//class MidNode(parent: MidNode?, var left: Node, var right: Node):Node(parent){
//    fun sum(num2: Node):Node{
...
//        return summed
//    }
//    fun sumOnly(num2: Node): MidNode{
//        this.parent =  MidNode(null, this, num2)
//        num2.parent = this.parent
//        return this.parent!!
//    }
//    override fun rightLeaf(): Leaf{
//        return right.rightLeaf()
//    }
//
//    override fun leftLeaf(): Leaf{
//        return left.leftLeaf()
//    }
//
//    fun rightNeighbour():Leaf?{
//        if(parent==null)
//            return null
...
//        newLeft?.let{it.parent = new}
//        newLeft?.let{it.parent = new}
//        return new
//    }
//}
//
//class Leaf(parent: MidNode?, var value: Int) : Node(parent){
//    override  fun rightLeaf(): Leaf{
//        return this
//    }
//
