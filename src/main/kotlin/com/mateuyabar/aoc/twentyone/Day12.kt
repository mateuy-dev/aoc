...
//        findPaths(startNode!!, listOf<Node>(), result, false)
//        return result
//    }
//
...
//    }
//
//    private fun findPaths(node: Node, visited: List<Node>, paths: MutableList<List<Node>>, singleRevisited: Boolean) {
//        if(node.name == "end") {
//            //println(visited)
...
//            }
//            paths.add(visited)
//        }else if(visited.size>1 && node.name == "start"){
//            // dead end
//        } else if(!node.big && visited.count { it.name==node.name}==2){
//            // dead end
//        } else if(!node.big && visited.count { it.name==node.name}==1 && singleRevisited){
//            // dead end
//        } else {
//            var newSingleNodeVisited = singleRevisited
//            if(!node.big && visited.count { it.name==node.name}==1){
//                newSingleNodeVisited = true
//            }
//            val newVisited = visited+node
//            for(newNode in node.edges){
//                findPaths(newNode, newVisited, paths, newSingleNodeVisited)
//            }
//        }
//    }
//}
